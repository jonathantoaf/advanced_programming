...
public class MainTrain {
    ...
    public static void main(String[] args) {
        ...
        gc.setConfFile("/Users/jonathan/Documents/BarIlan/advanced_programming/ap_final_project/src/test/simple.conf"); // change to the exact loaction where you put the file.
        gc.create();
